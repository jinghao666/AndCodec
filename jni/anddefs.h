...
// total len: 16 byte
	...
	unsigned char	uchar_d0;

	//reserved
	unsigned char	uchar_d1;
	unsigned char	uchar_d2;
	unsigned char	uchar_d3;
	unsigned char	uchar_d4;
	unsigned char	uchar_d5;
	unsigned char	uchar_d6;
	unsigned char	uchar_d7;
}OpaqueData; 
